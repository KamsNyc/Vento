  ...
  return (
    <section id="about" className="max-h-[961px] md:max-h-[528px] w-full ">
      ...
      <div className=" px-4 xl:px-[138px] block md:flex items-center justify-between my-[41px] lg:py-0 md:gap-[80px] lg:my-[64px]">
        {/* LEFT */}
        <div className="block lg:flex text-left w-full lg:w-1/2 h-full text-[#4E4E4E] text-[20.38px] font-[300] leading-[24px] max-h-[492px] lg:max-h-[252px] mb-[38px] md:mb-0">
