...
function HeroSection() {
  return (
    ...
    <div className="absolute inset-0 flex flex-col items-center justify-center lg:items-start lg:text-left lg:justify-center lg:pl-[137px] ">
      ...
      <h1 className="text-[46px] font-medium leading-[55px] px-[30px] lg:px-0 lg:max-w-[700px] lg:leading-[78px] lg:text-[61px]">Expert HVAC Design for a <span className="text-[#1A63BB]">Comfortable</span> and <span className="text-[#1A63BB]">Sustainable Home</span></h1>
    </div>
  </section>
  )
}
